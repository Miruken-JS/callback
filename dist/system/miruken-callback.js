        ...
        execute: function () {
            ...
            function $define(tag, variance) {
                ...
                definition.dispatch = function (handler, callback, constraint, composer, all, results) {
                    ...
                    var ok = delegate && _dispatch(delegate, $meta(delegate), callback, constraint, v, composer, all, results);
                    if (!ok || all) {
